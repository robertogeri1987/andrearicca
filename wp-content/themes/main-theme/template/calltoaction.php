<section class="">
    <div class="row">
        <div class="col-md-6 text-white bg-dark py-12 px-5">
            ...
            <a href="" class="btn">Fissa un appuntamento online</a>
        </div>
        <div class="col-md-6 bg-grey-light py-12 px-5 position-relative">
            <h2 class="mb-5 text-dark">Hai un emergenza?<br>
